    ...
    function filter_submit_review_page_content( string $content ): string {
        ...
        <div class="mass-reviews container container-px">
            <div class="review-intro">
                <h1 class="bold"><?php echo esc_html__('La tua opinione è importante per noi', 'nutrisslim-suite'); ?></h1>
                <p><?php echo esc_html__('Da Nature\'s Finest ci impegniamo sempre a fornire i migliori prodotti e servizi ai nostri stimati clienti. Vorresti valutare il tuo ultimo acquisto?', 'nutrisslim-suite'); ?></p>
                <p><?php echo esc_html__('Come ringraziamento per il tuo tempo, ti invieremo un regalo speciale insieme al tuo ordine!', 'nutrisslim-suite'); ?></p>

                <h4><?php echo esc_html__('Il tuo ordine', 'woocommerce'); ?></h4>
                ...
                <h4><?php echo esc_html__('Valuta e recensisci il tuo acquisto', 'nutrisslim-suite'); ?></h4>
            </div>
            ...
            <div class="form">
                <div class="nf-review_form">
                    <div class="review_fields">
                        ...
                        <textarea name="review_review" id="review_text" cols="30" rows="5" placeholder="<?php echo esc_attr__('Dicci cosa ne pensi','nutrisslim-suite'); ?>"></textarea>
                        <button id="send_reviews"><?php echo esc_html__('Invia','woocommerce'); ?></button>
                    </div>
                </div>
            </div>
        </div>
