...
<?php 
	...
	if ( $order->has_status( 'pending' ) ){
		global $emailMSG; $emailMSG = __( 'Zamówienie zostało utworzone dla Ciebie.', 'underStrap' ) . '<br>' .' <a href="' . esc_url( $order->get_checkout_payment_url() ) . '" style="color:#1fb25a">' . esc_html__( 'Opłać to zamówienie', 'woocommerce' ) . '</a>';
	}
