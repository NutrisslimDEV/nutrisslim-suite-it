                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="line-height: 24px; font-size: 12px; text-align: left; margin: 0;"><span
                                        style="font-size: 14px;"><strong><?php echo __('Dati del cliente', 'woocommerce')?>:</strong></span>
                                </p>
                            </div>
                        </div>
...
?>
    <strong><span style="font-size: 14px; line-height: 19px;"><?= $billingAddress['company']; ?></span></strong><br>
<?php
} else {
?>
    <strong><span style="font-size: 14px; line-height: 19px;"><?= $billingAddress['first_name']; ?> <?= $billingAddress['last_name']; ?></span></strong><br>
<?php
}
if($billingVatID){
?>
    <span style="font-size: 14px; line-height: 19px;"><?= apply_filters( 'wpml_translate_single_string', 'Davčna številka', 'naturesfinest', 'Davčna številka', $translation_language ) . ': ' . $billingVatID; ?></span><br>
<?php
}
if($billingAddress['company']){
?>
    <span style="font-size: 14px; line-height: 19px;"><?= $billingAddress['first_name']; ?> <?= $billingAddress['last_name']; ?></span><br>
<?php
}
?>
    <span style="font-size: 14px; line-height: 19px;"><?= $billingAddress['address_1']; ?> <?= $billingAddress['address_2']; ?></span><br>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="line-height: 19px; font-size: 12px; text-align: left; margin: 0;"><span
                                        style="font-size: 14px;"><strong><?php echo __('Dettagli della spedizione', 'woocommerce')?>:</strong></span>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
...
<?php if($shippingAddress['company']) : ?>
    <strong><span style="font-size: 14px; line-height: 19px;"><?= $shippingAddress['company']; ?></span></strong><br>
    <span style="font-size: 14px; line-height: 19px;"><?= $shippingAddress['first_name']; ?> <?= $shippingAddress['last_name']; ?></span><br>
<?php else : ?>
    <strong><span style="font-size: 14px; line-height: 19px;"><?= $shippingAddress['first_name']; ?> <?= $shippingAddress['last_name']; ?></span></strong><br>
<?php endif; ?>
...
<?php if ($shipping_state_name) : ?>
    <span style="font-size: 14px; line-height: 19px;"><?= $shipping_state_name; ?></span><br>
<?php endif; ?>
                                    <span
