                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; text-align: center; margin: 0;">
                                    <span
                                        style="color: #999999; font-size: 14px; line-height: 19px;"><?php echo __('Numero dell\'ordine:', 'woocommerce');?></span>
                    ...
                    ?>
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; text-align: center; margin: 0;">
                                    <span
                                        style="color: #999999; font-size: 14px; line-height: 19px;"><?php echo __('Data:', 'woocommerce');?></span>
                    ...
                    <![endif]-->
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; text-align: center; margin: 0;">
                                    <span
                                        style="color: #999999; font-size: 14px; line-height: 19px;"><?php echo __('Importo', 'woocommerce');?>:</span>
                            ...
                            <div
                                ...
                                <p style="line-height: 36px; text-align: center; font-size: 12px; margin: 0;">
                                    <span style="font-size: 24px;">
                                        <strong><?php echo __('Ordine', 'woocommerce');?></strong>
                                    </span>
                                </p>
                                <p
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 15px; text-align: center; margin: 0;"><span
                                        style="font-size: 14px; line-height: 19px; mso-ansi-font-size: 14px;"><strong><?php echo __('Prodotto', 'woocommerce'); ?>:</strong></span>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="line-height: 15px; text-align: center; font-size: 12px; margin: 0;"><span
                                        style="font-size: 14px; line-height: 19px; mso-ansi-font-size: 14px;"><strong><?php echo __('Quantità', 'woocommerce'); ?>:</strong></span>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; text-align: center; margin: 0;"><span
                                        style="font-size: 14px; line-height: 19px; mso-ansi-font-size: 14px;"><strong><?php echo __('Prezzo', 'woocommerce');?>:</strong></span>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; margin: 0;"><span
                                        style="font-size: 14px;"><?php echo __('Prodotti', 'woocommerce'); ?><br><span
                                            style="font-size: 12px; line-height: 14px; white-space: nowrap;"><?php echo __('(Comprensivo di IVA)', 'woocommerce'); ?></span></span>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; margin: 0;">
                                    <span
                                        style="font-size: 14px;"><?php echo __('Importo per la spedizione', 'woocommerce'); ?><br></span></span>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; margin: 0;text-align:left;"><span
                                        style="font-size: 14px;"><?php echo __('Kupon:', 'woocommerce') . ' ' . $coupon_code; ?>
                                        <br></span></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; margin: 0;">
                                    <?php echo __('Metodo di pagamento:', 'woocommerce'); ?></p>
                                <p style="font-size: 14px; line-height: 19px; margin: 0;"><span
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="line-height: 24px; font-size: 12px; text-align: left; margin: 0;"><span
                                        style="font-size: 14px;"><strong><?php echo __('Uwaga klienta', 'woocommerce'); ?>:</strong></span>
                                </p>
                            </div>
                        </div>
                        <div
