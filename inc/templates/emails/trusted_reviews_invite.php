        ...
        <div
            ...
            <p style="line-height: 19px; font-size: 12px; text-align: center; margin: 0; margin-bottom:10px;"
                align="left"><span style="line-height: inherit; font-size: 14px;"><strong
                        style="line-height: inherit;"><?php echo __('Valuta Nature\'s Finest e ricevi un premio!', 'nutrisslim-suite'); ?></strong></span>
            </p>
            <p
                ...
                <?php echo __('Ci impegniamo sempre a migliorare i nostri prodotti e servizi e apprezziamo molto il tuo feedback', 'nutrisslim-suite'); ?>
            </p>
            <p
                style="margin: 0; margin-bottom:10px; font-size: 14px; line-height: 21px; color: #555555; font-family: 'Oxygen', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;">
                <?php echo __('<b>Valuta la tua esperienza con noi</b> - e come ringraziamento invieremo un <b>regalo speciale</b> con il tuo ordine!', 'nutrisslim-suite'); ?>
            </p>
            ...
            <p
                ...
                <a href="<?php echo $trusted_review_link; ?>" target="_blank"
                    ...
                    bgcolor="#1fb25a">
                    <?php echo __('VALUTA IL NEGOZIO ORA', 'nutrisslim-suite'); ?>
                </a>
            </p>
            <p
                ...
                <a href="<?php echo $trusted_review_link; ?>" target="_blank"
                    style="text-decoration:none!important; color: #555555!important;"><?php echo __('Guarda il resto', 'nutrisslim-suite'); ?>
                    <img align="center" alt="Image" border="0" class="center autowidth "
                        ...
                        title="Image" width="82" height="14"> <?php echo __('recensioni!', 'nutrisslim-suite'); ?></a>
            </p>
        </div>
    </div>
</div>