...
class Nutrisslim_Landing_Quantity_Selector extends Widget_Base {
    ...
    protected function render() {
        ...
        if ($singlePriceWithTax >= $free_shipping_threshold) {
            $shippingCost = __('Spedizione gratuita', 'nutrisslim-suite');
        } else {
            $shippingCost = floatval(str_replace(',', '.', $shippingCost));
            $shippingCost = __('Costi di spedizione', 'nutrisslim-suite') . ' ' . wc_price($shippingCost);
        }
                ...
                <div class="slick-track" style="opacity: 1; width: 450px;">
                    <div class="slide slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false"
                        ...
                        <div class="slider-flex">
                            <span class="slide-content"><?php _e('MODULO D\'ORDINE', 'nutrisslim-suite'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 pt-3 icon-check icon-primary-color text-center">
                ...
                <div class="col-12 pt-3 shipping-details">
                    <?php
                            ...
                            echo sprintf( __('%s entro 1-3 giorni lavorativi', 'nutrisslim-suite'), $delivery_type, $courier, $from, $to ) . '</p>';
                            ?>
                </div>

                <?php if (!empty($quantities[1]['price']) || !empty($quantities[2]['price'])) { ?>
                <div class="text-center cta-notice">
                    <h3><?php _e('Compra di più, risparmia di più', 'nutrisslim-suite'); ?></h3>
                </div>
                <?php } else {
                            ...
                            echo '<p class="redno">' . __('Prezzo normale', 'woocommerce') . ':<br /><span><s>' . wc_price($regular_price) . '</s></span></p>';
...
<div id="upsell-block" class="style-a<?php echo $upsell_block_option == 'upsell-block-a' ? '' : ' d-none'; ?>"
    ...
    <?php
                    $custom_titles = array(
                        1 => !empty($package_1_text) ? $package_1_text : __('Ordina 1 pacchetto', 'nutrisslim-suite'),
                        2 => !empty($package_2_text) ? $package_2_text : __('Ordina 2 pacchetti', 'nutrisslim-suite'),
                        3 => !empty($package_3_text) ? $package_3_text : __('Ordina 3 pacchetti', 'nutrisslim-suite')
                    );

                    $custom_titles2 = array(
                        1 => __('1x pacchetto', 'nutrisslim-suite'),
                        2 => __('2x pacchetti', 'nutrisslim-suite'),
                        3 => __('3x pacchetti', 'nutrisslim-suite')
                    );
                    ...
                    foreach ($quantities as $key => $item) {
                        ...
                        if ($key == 1) {
                            echo '<div class="text-center cta-notice mobile"><h3>' . __('Compra di più, risparmia di più', 'nutrisslim-suite') . '</h3></div>';
                        }
        ...
        <div class="offer-container">
            ...
            <div class="bottom">
                                ...
                                <label for="checked0<?php echo $num; ?>">
                                    ...
                                    <?php 
                                                            if ($consumption_period && $duration > 0) {
                                                                echo '<p style="font-size: smaller; padding-left: 20px; font-weight:300; padding-top: 10px"> per ' . $duration . ' giorni</p>';
                                                            }
                                                            ?>
                                </label>
                            </div>
                            <div class="price">
                                <div class="price-old price-small">
                                    <span class="line-through precrtano">
                                        <?php echo sprintf(__('Prezzo regolare %s', 'nutrisslim-suite'), wc_price($regular_price * $num)); ?>
                                    </span>
                                </div>
                ...
                <div class="offer_shipping">
                    ...
                    <?php _e('Spedizione gratuita', 'nutrisslim-suite'); ?>
                </div>
                <?php } ?>
                ...
                <div class="offer_shipping">
                    ...
                    <?php _e('Regalo gratuito', 'nutrisslim-suite'); ?>
                </div>
                <?php } ?>
            </div>
        </div>
    ...
    <div class="offer custom_offer offer<?php echo $key . ' ' . ($key == 0 ? 'active' : ''); ?>">
        ...
        <label for="offer<?php echo $key; ?>" class="offer-label">
            <div class="offer-container">
                ...
                <div class="shipping-cost">
                    <span><b><?php _e('Costi di spedizione 4,90 €', 'nutrisslim-suite'); ?></b></span>
                </div>
                <?php } ?>
        ...
        <?php if ($upsell_block_option == 'upsell-block-c') : ?>
            ...
            <div id="upsell-block" class="style-c<?php echo $upsell_block_option == 'upsell-block-c' ? '' : ' d-none'; ?>"
                ...
                foreach ($quantities as $key => $item) {
                    ...
                    if ($key == 1) {
                        echo '<div class="text-center cta-notice mobile"><h3>' . __('Acquista di più, risparmia di più', 'nutrisslim-suite') . '</h3></div>';
                    }
                            ...
                            <div class="offer-container">
                                ...
                                <div class="bottom">
                                    ...
                                    <span class="price-per-product-text">
                                        ...
                                        <?php _e('/ per prodotto', 'nutrisslim-suite'); ?>
                                    </span>
                                            </div>
                                        ...
                                        <div class="offer-left">
                                            ...
                                            type="checkbox" ' . ($key == 0 ? 'checked' : '') .
                                                    ...
                                                    <label for="checked0_c_<?php echo esc_attr($num); ?>">
                                                        ...
                                                        if ($consumption_period && !empty($duration)) {
                                                            echo '<p style="font-size: smaller; padding-left: 20px; font-weight:300; padding-top: 5px; font-family: "Fira Sans", Sans-serif"> na ' . esc_html($duration) . ' dni</p>';
                                                        }
                                                        ?>
                                                    </label>
                                                </div>
                                            ...
                                            <span class="line-through precrtano regularofferc">
                                                <?php
                                                echo sprintf(
                                                    __('Prezzo normale. %s', 'nutrisslim-suite'),
                                            ...
                                            <span class="offerc-price eec totalofferc">
                                                <?php
                                                echo __('Totale: ', 'nutrisslim-suite'); // Add "Total:" before the price
                                    ...
                                    <?php if ($quantities[$key]['free_shipping'] || $freeshipping) { ?>
                                        <div class="offer_shipping">
                                            ...
                                            <?php _e('Consegna gratuita', 'nutrisslim-suite'); ?>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <?php if (!empty($quantities[$key]['gift']) && isset($quantities[$key]['gift'][0])) { ?>
                                        <div class="offer_shipping">
                                            ...
                                            <?php _e('Omaggio', 'nutrisslim-suite'); ?>
                                        </div>
                                    <?php } ?>
...
<div id="offer-loader" class="">
    <div class="preloader-content">
        <h2>Aggiornamento dell'offerta ...</h2>
