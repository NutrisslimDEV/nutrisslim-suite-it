                ...
                <div class="revContent">
                    ...
                    <div class="rateMeta">
                        ...
                        <div class="checker"><span class="check"><img
                            ...
                            <?php echo __('Utente verificato', 'nutrisslim-suite'); ?></div>
                    </div>
    ...
    <div class="col contHolder product-short-description">
        ...
        <?php
                ...
                if ( !empty($consumption_period) ) {
                    $consumptionPeriodOutput = sprintf( __('per %s giorni', 'nutrisslim-suite'), $consumption_period );
                }
                ...
                echo '<p class="redno">' . __('Prezzo regolare', 'woocommerce') . ':<br /><span>' . wc_price($regular_price) . '</span></p>';
                echo '<div class="price-main price-large">' . wc_price($price_for_one) . '</div>';
                echo '<p><a href="#order-form-anchor" class="org-btn">' . __('Ordina ora', 'woocommerce') . '</a></p>';
                echo '<p class="prihrani">' . __('e risparmia', 'nutrisslim-suite') . ' ' . wc_price($regular_price - $price_for_one) . '</p>';
                echo '<p>' . __('Acquisto 100% sicuro con politica di reso senza domande.', 'nutrisslim-suite') . '</p>';
            ?>
    </div>
</div>
<?php
