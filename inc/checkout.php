...
//         'placeholder' => __('Adres e-mail *', 'woocommerce'),
//         'required'    => true,
...
//         'placeholder' => __('Imię *', 'woocommerce'),
//         'required'    => true,
...
//         'placeholder' => __('Nazwisko *', 'woocommerce'),
//         'required'    => true,
...
//             'placeholder' => __('Ulica *', 'woocommerce'),
//             'required'    => true,
...
//             'type'      => 'text',
//             'label'     => __('Kućni br', 'nutrisslim-suite'),
//             'placeholder' => __('Kućni br.', 'nutrisslim-suite'),
...
//         $fields['billing']['billing_house_number'] = array(
//             'type'      => 'text',
//             'label'     => __('Nr domu', 'nutrisslim-suite'),
//             'placeholder' => __('Nr domu *', 'nutrisslim-suite'),
...
//         ); 
//         $fields['billing']['billing_city'] = array(
//             'label'       => __('Miejscowość / Miasto', 'woocommerce'),
//             'placeholder' => __('Miejscowość / Miasto *', 'woocommerce'),
//             'required'    => true,
//             'class'       => array('form-row-last'),
//             'priority' => 70,
//         );    
//         // Add billing zip code
//         $fields['billing']['billing_postcode'] = array(
//             'label'       => __('Kod pocztowy (np. 00-000)', 'woocommerce'),
//             'placeholder' => __('Kod pocztowy (np. 00-000)*', 'woocommerce'),
//             'required'    => true,
//             'class'       => array('form-row-first'),
//             'clear'       => true,
//             'priority' => 60,
...
//         'placeholder' => __('Numer telefonu*', 'woocommerce'),
//         'required'    => true,
//         'class'       => array('form-row-wide'),
//         'priority'    => 80,
//     );    
...
//         'type'        => 'textarea',
//         'class'       => array('notes'),
//         'label'       => __('Uwagi do dostawy', 'woocommerce'),
//         'placeholder' => __('Uwagi do dostawy ', 'woocommerce'),
//         'priority'    => 100,
//     );
...
//         'MB' => __('Monza e Brianza', 'woocommerce'),
...
//     $fields['billing']['billing_email'] = array(
//         'type'        => 'email',
//         'label'       => __('Indirizzo e-mail', 'woocommerce'),
//         'placeholder' => __('Indirizzo e-mail *', 'woocommerce'),
//         'required'    => true,
//         'class'       => array('form-row-wide'),
//         'priority'    => 10,
//     );
...
//         'placeholder' => __('Nome *', 'woocommerce'),
//         'required'    => true,
//         'class'       => array('form-row-first'),
//         'priority'    => 20,
//     );
//     $fields['billing']['billing_last_name'] = array(
//         'type'        => 'text',
//         'label'       => __('Cognome', 'woocommerce'),
//         'placeholder' => __('Cognome *', 'woocommerce'),
//         'required'    => true,
//         'class'       => array('form-row-last'),
//         'priority'    => 30,
//         'clear'       => true,
...
//             'placeholder' => __('Via *', 'woocommerce'),
//             'required'    => true,
//             'class'       => array('form-row-last street-field'),
//             'priority'    => 50,
//         );
//         $fields['billing']['billing_house_number'] = array(
//             'type'      => 'text',
//             'label'     => __('Numero civico', 'nutrisslim-suite'),
//             'placeholder' => __('Numero civico *', 'nutrisslim-suite'),
//             'class' => array('form-row-first house_number-field'),
//             'required' => 1,
//             'priority' => 40,
//             'clear'       => true,
...
//         // Add billing zip code
//         $fields['billing']['billing_postcode'] = array(
//             'label'       => __('Codice postale', 'woocommerce'),
//             'placeholder' => __('Codice postale *', 'woocommerce'),
//             'required'    => true,
//             'class'       => array('form-row-first'),
//             'clear'       => true,
//             'priority' => 60,
...
//         $fields['billing']['billing_address_1'] = array(
//             'type'        => 'text',
//             'label'       => __('Strada', 'woocommerce'),
//             'placeholder' => __('Strada *', 'woocommerce'),
//             'required'    => true,
//             'class'       => array('form-row-first street-field'),
//             'priority'    => 40,
//         );
//         $fields['billing']['billing_house_number'] = array(
//             'type'      => 'text',
//             'label'     => __('Numero della casa', 'nutrisslim-suite'),
//             'placeholder' => __('Numero della casa *', 'nutrisslim-suite'),
//             'class' => array('form-row-last house_number-field'),
//             'required' => 1,
//             'priority' => 50,
//             'clear'       => true,
//         );
//         $fields['billing']['billing_city'] = array(
//             'label'       => __('Località / Città', 'woocommerce'),
//             'placeholder' => __('Località / Città *', 'woocommerce'),
//             'required'    => true,
//             'class'       => array('form-row-last'),
//             'priority' => 70,
//         );
//         // Add billing zip code
//         $fields['billing']['billing_postcode'] = array(
//             'label'       => __('CAP', 'woocommerce'),
//             'placeholder' => __('CAP *', 'woocommerce'),
//             'required'    => true,
//             'class'       => array('form-row-first'),
//             'clear'       => true,
//             'priority' => 60,
...
//     $fields['billing']['billing_phone'] = array(
//         'type'        => 'tel',
//         'label'       => __('Numero di telefono', 'woocommerce'),
//         'placeholder' => __('Numero di telefono *', 'woocommerce'),
//         'required'    => true,
//         'class'       => array('form-row-wide'),
//         'priority'    => 80,
//     );

//     if ($default_country == 'IT') {
//         // Add billing province dropdown
...
//     if ($default_country == 'IT') {
//         // Add billing province dropdown
//         // Add shipping province dropdown
...
//         'type'        => 'textarea',
//         'class'       => array('notes'),
//         'label'       => __('Note sulla consegna', 'woocommerce'),
//         'placeholder' => __('Note sulla consegna ', 'woocommerce'),
//         'priority'    => 100,
//     );
...
// function validate_province_fields($fields, $errors) {
//     if (isset($_POST['billing_province']) && empty($_POST['billing_province'])) {
//         $errors->add('validation', __('Per favore, seleziona una provincia per la fatturazione.', 'woocommerce'));
//     }

//     // if (isset($_POST['shipping_province']) && empty($_POST['shipping_province'])) {
//     //     $errors->add('validation', __('Per favore, seleziona una provincia per la spedizione.', 'woocommerce'));
//     // }
// }
// add_action('woocommerce_after_checkout_validation', 'validate_province_fields', 10, 2);


// function save_province_to_order_meta($order_id) {
...
//         update_post_meta($order_id, '_shipping_province', sanitize_text_field($_POST['shipping_province']));
//     }
// }
// add_action('woocommerce_checkout_update_order_meta', 'save_province_to_order_meta');


// function display_province_in_admin_order_meta($order) {
//     $billing_province = get_post_meta($order->get_id(), '_billing_province', true);
//     $shipping_province = get_post_meta($order->get_id(), '_shipping_province', true);

//     if ($billing_province) {
//         echo '<p><strong>' . __('Provincia di Fatturazione', 'woocommerce') . ':</strong> ' . esc_html($billing_province) . '</p>';
//     }

//     if ($shipping_province) {
//         echo '<p><strong>' . __('Provincia di Spedizione', 'woocommerce') . ':</strong> ' . esc_html($shipping_province) . '</p>';
//     }

// }
// add_action('woocommerce_admin_order_data_after_billing_address', 'display_province_in_admin_order_meta', 10, 1);
// add_action('woocommerce_admin_order_data_after_shipping_address', 'display_province_in_admin_order_meta', 10, 1);
...
function customize_checkout_fields($fields) {
    ...
    if ($default_country == 'IT') {
        $fields['billing']['billing_state'] = array(
            ...
            'priority'    => 75,
            'options'     => WC()->countries->get_states('IT'), // Get Italian provinces from WooCommerce
        );
    ...
    if ($default_country == 'GB') {
        ...
        $fields['billing']['billing_address_1'] = array(
            'type'        => 'text',
            'label'       => __('Indirizzo completo (via/strada/piazza)', 'woocommerce'),
            'placeholder' => __('Indirizzo completo (via/strada/piazza) *', 'woocommerce'),
            'required'    => true,
            'class'       => array('form-row-first street-field'),
            'priority'    => 40,
            'maxlength'   => 40, // Max 10 characters
        );
        $fields['billing']['billing_house_number'] = array(
            'type'      => 'text',
            'label'     => __('N°', 'nutrisslim-suite'),
            'placeholder' => __('Numero civico *', 'nutrisslim-suite'),
            'class' => array('form-row-last house_number-field'),
            'required' => 1,
            'priority' => 50,
        ...
        $fields['billing']['billing_city'] = array(
            'label'       => __('Luogo / Località', 'woocommerce'),
            'placeholder' => __('Luogo / Località*', 'woocommerce'),
            'required'    => true,
            'class'       => array('form-row-last'),
            'priority' => 70,
        );
    ...
    $fields['billing']['billing_phone'] = array(
        'type'        => 'tel',
        'label'       => __('Numero di telefono', 'woocommerce'),
        'placeholder' => __('0547 123123 *', 'woocommerce'),
        'required'    => true,
        'class'       => array('form-row-wide'),
        'priority'    => 80,
    ...
    $fields['shipping']['shipping_phone'] = array(
        'type'        => 'tel',
        'label'       => __('0547 123123', 'woocommerce'),
        'placeholder' => __('0547 123123 *', 'woocommerce'),
        'required'    => true,
        'class'       => array('form-row-wide'),
        'priority'    => 80,
...
function add_italian_provinces($states) {
    $states['IT'] = array(
        ''   => __('Provincia *', 'woocommerce'),
        'AG' => 'Agrigento',
        'AL' => 'Alessandria',
...
add_filter('woocommerce_states', 'add_italian_provinces');

function save_woocommerce_states($order_id) {
    ...
    // Save billing and shipping state
    update_post_meta($order_id, '_billing_state', $billing_state);
    update_post_meta($order_id, '_billing_state_custom', $billing_state);

    update_post_meta($order_id, '_shipping_state', $shipping_state);
    update_post_meta($order_id, '_shipping_state_custom', $shipping_state);

    // Ensure WooCommerce order object saves the correct states
...
add_action('woocommerce_checkout_update_order_meta', 'save_woocommerce_states');

function autofill_shipping_state_script() {
    if (is_checkout()) {
        ?>
        <script type="text/javascript">
            jQuery(function($){
                // When billing state changes, update shipping state if checkbox is checked
                $('#billing_state').on('change', function(){
                    if ($('#ship-to-different-address input').is(':checked') === false) {
                        $('#shipping_state').val($(this).val()).trigger('change');
                    }
                });

                // On page load, if shipping is not checked, copy the billing state
...
add_action('wp_footer', 'autofill_shipping_state_script');



function display_woocommerce_states_admin_order_meta($order) {
    $billing_state = get_post_meta($order->get_id(), '_billing_state_custom', true);
    $shipping_state = get_post_meta($order->get_id(), '_shipping_state_custom', true);

    if ($billing_state) {
        echo '<p><strong>' . __('Provincia di Fatturazione:', 'woocommerce') . '</strong> ' . esc_html($billing_state) . '</p>';
    }

    if ($shipping_state) {
        echo '<p><strong>' . __('Provincia di Spedizione:', 'woocommerce') . '</strong> ' . esc_html($shipping_state) . '</p>';
    }
}
add_action('woocommerce_admin_order_data_after_billing_address', 'display_woocommerce_states_admin_order_meta', 10, 1);
add_action('woocommerce_admin_order_data_after_shipping_address', 'display_woocommerce_states_admin_order_meta', 10, 1);

// VALIDATION DU CODE POSTAL
// Output the inline JavaScript in the footer
add_action('wp_footer', 'postnr_add_inline_js');
function postnr_add_inline_js(){
    ?>
    <script type="text/javascript">
...
add_action('woocommerce_checkout_process', 'validate_billing_postcode_format');
function validate_billing_postcode_format() {
    $postcode = isset($_POST['billing_postcode']) ? sanitize_text_field($_POST['billing_postcode']) : '';

    // Check if exactly 5 digits
    if ( ! preg_match('/^\d{5}$/', $postcode) ) {
        wc_add_notice(__('Inserire un codice postale valido di cinque cifre.'), 'error');
    }
}
            ...
            <div class="rf-option-container"' . $is_colored . '>
                <div class="rf-option-left">
                    ...
                    <label for="rf_' . esc_attr($free_shipping_method->id) . '">
                        <div class="rf-option-title">' . esc_html($free_shipping_method->label) . $type . ' (' . esc_attr(__('Gratuito', 'woocommerce')) . ')</div>
                        <div class="rf-option-description"></div>
                    </label>
                </div>
            </div>';
    ...
    if (isset(WC()->session->chosen_payment_method) && WC()->session->chosen_payment_method === 'cod') {
        ...
        if (isset($payment_gateways['cod'])) {
            ...
            if ($extra_fee_inclusive && is_numeric($extra_fee_inclusive)) {
                ...
                WC()->cart->add_fee(__('Supplemento per il pagamento in contrassegno', 'woocommerce'), (float) $extra_fee_exclusive, true, $tax_class);
            }
        }
    }
}
...
function add_h3_order_summary_title() {
    ...
    echo '<h3 id="payment_method_heading_inner">' . esc_html__('Metodi di pagamento', 'woocommerce') . '</h3>';
...
function additional_elements() {
    echo '<h3 id="order_review_heading_inner">' . esc_html__('Il tuo ordine', 'woocommerce') . '<span class="toggle">' . esc_html__('Mostra / Nascondi', 'nutrisslim-suite') . '</span></h3>';
    echo '<p id="final-message">' . esc_html__('Questo è un ordine con obbligo di pagamento. Effettuando l\'ordine, accetti questa condizione. Ci impegniamo a proteggere e rispettare la tua privacy e utilizzeremo i tuoi dati personali esclusivamente per gestire il tuo ordine o account e fornire informazioni sui prodotti ordinati da noi.', 'nutrisslim-suite') . '</p>';
}
...
function get_checkout_offer_ajax() {
        ...
        foreach ($items as $item) {
            ...
            echo '<img decoding="async" src="/wp-content/uploads/2024/04/Home-Ikone-NOVO_cart.svg" alt="Aggiungi al carrello" style="vertical-align: middle; margin-right: 8px;">' . __('Aggiungi al carrello', 'woocommerce') . '</a>';
            echo '</div>'; // col-12
